...
public class ScoreMasterTest
{
    ...
    public void T01_Bowl23()
    {
        ...
        Assert.AreEqual(pointsPerFrame.ToList(), ScoreMaster.ScoreFrames (rolls.ToList()));
    }
    ...
    public void T03_Bowl2345()
    {
        int[] rolls = { 2, 3, 4, 5 };
        int[] points = { 5, 9 };
        Assert.AreEqual(points.ToList(), ScoreMaster.ScoreFrames(rolls.ToList()));
    }
    ...
    [Test]
    public void T18_AllStrikeFrameScore()
    {
    ...
    [Test]
    public void T18b_TestAllStrikes()
    {
        int[] rolls = { 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10 };
    ...
    [Test]
    public void TXX_MyTest()
    {
        int[] rolls = { 10, 10, 10, 7, 2, 8, 2, 5, 2, 10, 1, 1, 0, 0, 2, 8, 10 };
        int[] frames = { 30, 57, 76, 85, 100, 107, 119, 121, 121, 141 };
